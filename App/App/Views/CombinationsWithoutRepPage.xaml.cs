...
public partial class CombinationsWithoutRepPage : ContentPage
{

	public CombinationsWithoutRepPage()
	{
		InitializeComponent();
	}
	...
	private void OnCalculateClicked(object sender, EventArgs e)
	{
		...
		{
			var result = MathHelper.Factorial(intN) / (MathHelper.Factorial(intN - intK) * MathHelper.Factorial(intK));
